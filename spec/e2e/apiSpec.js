...
describe("The API", function () {
  ...
  it("should respond to a GET request at /api/keywords/categories", function (done) {
    ...
    async.series(
      [
        function (callback) {
          resetDatabase(deSession, callback);
        },
    ...
    it("should update a keyword when receiving a POST request at /api/keywords/:id/", function (done) {
      var expected = {
        _items: [{ id: 1, value: "Onion", categoryID: 2 }],
      };
      var body = {
        id: 1,
        value: "Onion",
  ...
  it("should remove a keyword when receiving a DELETE request at /api/keywords/:\
id/", function (done) {
    var expected = {
      _items: [{ id: 1, value: "Aubergine", categoryID: 1 }],
    };
    async.series(
      [
        function (callback) {
